...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 0, .box_w = 9, .box_h = 8, .ofs_x = -4, .ofs_y = 0},
    {.bitmap_index = 9, .adv_w = 914, .box_w = 43, .box_h = 70, .ofs_x = 7, .ofs_y = 0},
    {.bitmap_index = 386, .adv_w = 914, .box_w = 7, .box_h = 67, .ofs_x = 44, .ofs_y = 3},
    {.bitmap_index = 445, .adv_w = 914, .box_w = 43, .box_h = 70, .ofs_x = 7, .ofs_y = 0},
    {.bitmap_index = 822, .adv_w = 914, .box_w = 43, .box_h = 70, .ofs_x = 8, .ofs_y = 0},
    {.bitmap_index = 1199, .adv_w = 914, .box_w = 43, .box_h = 67, .ofs_x = 7, .ofs_y = 3},
    {.bitmap_index = 1560, .adv_w = 914, .box_w = 43, .box_h = 70, .ofs_x = 7, .ofs_y = 0},
    {.bitmap_index = 1937, .adv_w = 914, .box_w = 43, .box_h = 70, .ofs_x = 7, .ofs_y = 0},
    {.bitmap_index = 2314, .adv_w = 914, .box_w = 43, .box_h = 67, .ofs_x = 7, .ofs_y = 3},
    {.bitmap_index = 2675, .adv_w = 914, .box_w = 43, .box_h = 70, .ofs_x = 7, .ofs_y = 0},
    {.bitmap_index = 3052, .adv_w = 914, .box_w = 43, .box_h = 70, .ofs_x = 7, .ofs_y = 0}
};
